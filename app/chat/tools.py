...
def validate_and_check_serviceability(db: Session, pincode: str, street_address: str | None = None) -> dict:
    ...
    return {
        ...
        "message": f"Great news! Pincode {cleaned} in {city}, {state_name} is serviceable! Please share your complete flat/building and street address to fetch the best local plans."
    }
